...
* My research interests lie in the areas of Networks, Security and Trusted Computing. Currently, I am very interested in the security of new networking and computing paradigms such as Software Defined Networking (SDN), Network Function Virtualisation (NFV), Network Slicing and Information-Centric Networking (ICN), Edge Computing, Containers (e.g. Docker) or Serverless Computing.
